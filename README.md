...
今日雀魂/雀魂运势 | 查看今天的雀魂运势
mjxp | 你打麻将的时候性癖是什么？
低情商<str1>高情商<str2> | 输出一张低情商与高情商的图
gocho <str1> <str2> | 输出一张gocho的图片
金龙盘旋 <str1> <str2> <str3> | 输出一张金龙盘旋图


## License


使用此软件代码须遵守 “MIT 协议” 与 “反 996 协议”。

您可以自由使用本项目的代码用于商业或非商业的用途，但必须附带 MIT 与 反 996 授权协议。
